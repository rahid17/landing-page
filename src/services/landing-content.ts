...
const defaultLandingContent: LandingContent = {
  ...
  benefits: [],
  benefitsSection: { heading: "Why Choose Organic Mehendi?", subheading: "Experience the difference of truly organic mehendi" },
  features: [],
  featuresSection: { heading: "What Makes Our Mehendi Special", subheading: "Every cone is packed with features that ensure the best experience" },
  whyChooseUs: "",
  whyChooseUsSection: { heading: "The Organic Difference", subheading: "" },
  gallerySection: { heading: "Product Gallery", subheading: "See the rich, dark stains our organic mehendi delivers" },
  reviewsSection: { heading: "What Our Customers Say", subheading: "Real reviews from real customers who love our mehendi" },
